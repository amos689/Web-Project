    ...
    <div class="col-md-8 col-md-offset-2">
        <form action="${pageContext.request.contextPath}/modify" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" value="${article.title}" name="title" class="form-control" id="title" placeholder="请输入标题"/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" value="${article.tags}" name="tags" class="form-control" id="tags" placeholder="请输入标签，以逗号分隔"/>
            </div>
            <div class="form-group text-center">
                <button type="submit" class="btn btn-primary" style="width: 50%">修改</button>
            </div>
        </form>
    </div>
</div>
